...
<style>
    ...
    /* Customer dropdown */
    .pos-customer-row { display: flex; gap: 0.6rem; align-items: center; flex-wrap: wrap; }
    .pos-select {
    ...
    .pos-id-input {
        ...
        padding: 0.75rem 1rem;
        background: var(--surface); border: 2px solid var(--rule);
        border-radius: 8px; font-family: inherit; font-size: 0.9rem; outline: none;
    }
    ...
    .pos-item-meta {
        ...
        margin-top: 0.25rem; font-size: 0.82rem; color: var(--muted);
    }
    ...
    @media (max-width: 1024px) {
        .pos-bottom { grid-template-columns: 1fr; }
    }
    ...
    /* No inline styles on inputs */
    input.pos-customer-input {
